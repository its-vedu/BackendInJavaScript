...
const loginUser = asyncHandler(async (req, res)=>{
    ...
    //username or email
    //password check
    //if password is right then generate and  send the refresh and access token in cookies form to user
    //return response
...
export {registerUser, loginUser, logoutUser, refreshAccessToken,
    changeCurrentPassword, getCurrentUser, updateAccountDetails, updatAvatar,
